-- Type: account_type (owner to USER)
...
-- Create relationship `classification` and `inventory` tables
...
CREATE TABLE public.favorites (
    ...
    CONSTRAINT fk_account FOREIGN KEY (account_id) REFERENCES public.account (account_id) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT fk_inv FOREIGN KEY (inv_id) REFERENCES public.inventory (inv_id) ON DELETE CASCADE ON UPDATE CASCADE
);